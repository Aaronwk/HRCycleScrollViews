...
#import "HRAbstractDotView.h"
#import "HRAnimatedDotView.h"
#import "HRDotView.h"
...
- (void)initialization
{
    self.dotViewClass           = [HRAnimatedDotView class];
...
- (UIView *)generateDotView
{
    ...
    if (self.dotViewClass) {
        ...
        if ([dotView isKindOfClass:[HRAnimatedDotView class]] && self.dotColor) {
            ((HRAnimatedDotView *)dotView).dotColor = self.dotColor;
        }
    } else {
...
{
    if (self.dotViewClass) {
        HRAbstractDotView *abstractDotView = (HRAbstractDotView *)[self.dots objectAtIndex:index];
        if ([abstractDotView respondsToSelector:@selector(changeActivityState:)]) {
            [abstractDotView changeActivityState:active];
        } else {
            NSLog(@"Custom view : %@ must implement an 'changeActivityState' method or you can subclass %@ to help you.", self.dotViewClass, [HRAbstractDotView class]);
        }
